...
- **Primary = acid cobalt `#2d6cff` with black ink.** Matches the system's primary-action rule (text on color always flips to black).
- **Destructive = hot pink `#ff0066`.**
- **Surfaces** climb near-black → `#0a0a0a` bg → `#111110` card → `#1a1a18` popover/secondary.
- **Focus ring** is cobalt, 2px, offset — no glow.
- **Charts** use the neon set (cobalt / cyan / pink / sky / teal).
